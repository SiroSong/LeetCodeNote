...
var getIntersectionNode = function(headA, headB) {
  ...
  /**
   * curAlen + commonLen + curBlen + commonLen = curBlen + commonLen + curAlen + commonLen
   * = (curAlen + commonLen + curBlen) + commonLen
   * = (curBlen + commonLen + curAlen) + commonLen
   */
  ...
  while (true) {
    ...
    [curA, curB] = [curA ? curA.next : headB, curB ? curB.next : headA]
  }
};
// @lc code=end
